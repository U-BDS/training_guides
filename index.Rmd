...
This resource is actively maintained by Lara Ianov and Austyn Trull.

# Training

U-BDS offers weekly data science office hours on Thursdays from 3:30pm-4:00pm. If you are a UAB trainee, staff or faculty please feel free to stop by. The Zoom information is in the `#datascience` channel of the following Slack group: https://join.slack.com/t/uablabs/signup (if you can find, just ask in `#datascience`)
