...
* rocker/rstudio does not currently work with arm Macs/Macs with the M1 chip. This is a known issue and will be resolved in an rstudio update next year. We are actively watching this issue and will update this guide once the fix becomes available. If you are experiencing this issue, there are some alternative approaches that can be taken, but go beyond the scope of this tutorial and we would be happy to discuss the approach that fits your needs best in Data Science Office Hours (Data Science Office Hours are listed on the home page).
